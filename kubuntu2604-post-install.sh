...
script_log () {
    log_file="$HOME/kubuntu2604-post-install.log"
...
echo -e "${colorblue}---------- Script de pós instalação do Kubuntu 26.04 LTS ----------${nocolor}"
echo
...
echo "Instalar o \"snapd\", o \"flatpak\" e adicionar o repositório \"flathub\"."
...
echo -e "${coloryellow}\nEsse script foi pensado para ser executado apenas em instalações limpas do Kubuntu 26.04 LTS${nocolor}"
echo -e "${coloryellow}após o sistema já ter sido totalmente atualizado e reiniciado.${nocolor}"
echo -e "Para ajuda e mais informações rode: ${colorblue}\"./kubuntu2604-kde-post-install.sh --help\"${nocolor}."
...
echo -e "A partição de Arquivo está montada em:${coloryellow} $arquivo${nocolor}."
echo
...
echo
echo "Para executar o script por completo, basta rodar \"./kubuntu2604-kde-post-install.sh\"."
...
echo "./kubuntu2604-kde-post-install.sh --basics --dependencies --apt"
echo
